...
const sender = conn.decodeLid(anu.participants[0])//132345273258041_1@s.whatsapp.net
...
const user =
groupMembers.find((u) => conn.decodeJid(u.lid) === sender) || {};
const bot =
groupMembers.find((u) => conn.decodeJid(u.lid) == conn.user.jid) || {};
